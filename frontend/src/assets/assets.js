        ...
        menu:[
            {
                category:"Pizzas",
                items:[
            { id: 1, name: "Margherita", price: 199, image:"https://i.pinimg.com/736x/9d/5d/30/9d5d3011f7771054bbd01b72ab235c68.jpg" },
    ...
    // restaurant 2
{
    ...
    menu:[
        {
            category:"Panner Tikka",
            items:[
                {id:3, name: "Malai Paneer Tikka", price:150},
                {id:3, name: "Achari Paneer Tikka", price:120},
            ]
        }
    ]
},
