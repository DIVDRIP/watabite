...
const Item = ({image, name, rating, category, reviews, time, onclick}) => {
  ...
  return (
   <div onClick={onclick} className='group hover:shadow-green-400 group-hover:shadow-sm cursor-pointer w-full  max-w-75 overflow-hidden rounded-2xl border border-white/30 bg-black shadow-[0_0_25px_rgba(34,197,94,0.25)] '>
<div className='relative border-b border-b-white'>
<img className=' group-hover:scale-110 transition ease-in-out h-55 w-full object-cover' src={image} alt="" />
